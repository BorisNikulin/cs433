...
After all the runs of the simulation, the final dataset is \SI{5.5}{\giga\byte}.
As a side note, the gzip comprised size of the whole data set is \SI{544}{\mega\byte}.
